...
BOT="https://raw.githubusercontent.com/driwwstore/asep/main/"
...
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e ""
echo -e " [${PURPLE}01${NC}]${NC} Add Domain   $NC "
echo -e " [${PURPLE}02${NC}]${NC} Renew Certificate Xray   $NC "
echo -e " [${PURPLE}03${NC}]${NC} Check Running   $NC "
echo -e " [${PURPLE}04${NC}]${NC} Change Banner   $NC "
echo -e " [${PURPLE}05${NC}]${NC} Bandwith Monitoring  $NC "
echo -e " [${PURPLE}06${NC}]${NC} Restart Service  $NC "
echo -e " [${PURPLE}07${NC}]${NC} Auto Reboot  $NC "
echo -e " [${PURPLE}08${NC}]${NC} Reboot Vps   $NC "
echo -e " [${PURPLE}09${NC}]${NC} Speed Test    $NC "
echo -e " [${PURPLE}10${NC}]${NC} Limit Speed   $NC "
echo -e " [${PURPLE}11${NC}]${NC} Webmin   $NC "
echo -e " [${PURPLE}12${NC}]${NC} Update Script  $NC "
echo -e " [${PURPLE}13${NC}]${NC} Change Bot    $NC "
