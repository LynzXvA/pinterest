...
echo -e " [${PURPLE}01${NC}]${NC} Renew Certificate Xray   $NC "
echo -e " [${PURPLE}01${NC}]${NC} Check Running   $NC "
echo -e " [${PURPLE}01${NC}]${NC} Change Banner   $NC "
echo -e " [${PURPLE}01${NC}]${NC} Bandwith Monitoring  $NC "
echo -e " [${PURPLE}01${NC}]${NC} Restart Service  $NC "
echo -e " [${PURPLE}01${NC}]${NC} Auto Reboot  $NC "
echo -e " [${PURPLE}01${NC}]${NC} Reboot Vps   $NC "
echo -e " [${PURPLE}01${NC}]${NC} Speed Test    $NC "
echo -e " [${PURPLE}01${NC}]${NC} Limit Speed   $NC "
echo -e " [${PURPLE}01${NC}]${NC} Webmin   $NC "
echo -e " [${PURPLE}01${NC}]${NC} Update Script  $NC "
echo -e " [${PURPLE}01${NC}]${NC} Change Bot    $NC "
