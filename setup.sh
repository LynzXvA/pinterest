...
# https://raw.githubusercontent.com/LynzXvA/permission/main/ip 
...
echo -e "${tyblue} Welcome To LynzXvA Project AutoScript Premium.....${NC} "
sleep 2
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/LynzXvA/pinterest/main/version  )
